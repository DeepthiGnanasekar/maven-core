...
public class MailUtil {
	    public static void sendMailUsingTLS(String host,
	      ...
	      public static void main(String[] args) {
	         ...
	         String username = "csenaresh@gmail.com";
	         String password = "m b s x l q p h l u c c z l s s"; //app password
	         String fromAddress = "deepthig11.08@gmail.com";
	         String toAddress = "anithanambi2000@gmail.com";
